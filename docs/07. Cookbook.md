...
This section will help you to further understand how LmcRbacMvc works by providing more concrete examples. If you have
...
- [Using LmcRbacMvc with Doctrine ORM](/docs/07.%20Cookbook.md#using-LmcRbacMvc-with-doctrine-orm)
    - [How to deal with roles with lot of permissions?](/docs/07.%20Cookbook.md#how-to-deal-with-roles-with-lot-of-permissions)
- [Using LmcRbacMvc and ZF2 Assetic](/docs/07.%20Cookbook.md#using-LmcRbacMvc-and-zf2-assetic)
- [Using LmcRbacMvc and ZfcUser](/docs/07.%20Cookbook.md#using-LmcRbacMvc-and-zfcuser)
...
is not the task of such service. The Permission-System should handle this. And we can, for this we have the
 [`AssertionPluginManager`](/src/LmcRbacMvc/Assertion/AssertionPluginManager.php) and here is how to do it:
...
Using DoctrineORM with LmcRbacMvc is very simple. You need to be aware from performances where there is a lot of permissions for roles.
